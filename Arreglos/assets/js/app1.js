...
console.log(numeros);
*/
//numeros.indexOf(num) iteramos cada numero del array y comprobamos si está repetido por el valor
//que devuelve la posición si es repetido false(num != index) filter omite este
const noRepetidos=numeros.filter((num,index)=>numeros.indexOf(num)==index);
